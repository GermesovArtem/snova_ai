...
ERRORS_RU = {
    # 1. Safety & Policy
    "violated Google's Generative AI Prohibited Use policy": "🛡 Ваш запрос или фото не прошли проверку безопасности. Пожалуйста, измените описание или используйте другое изображение на более нейтральное.",
    "safety": "🛡 Ваш запрос или фото не прошли проверку безопасности. Пожалуйста, измените описание или используйте другое изображение.",
    "policy": "🛡 Запрос отклонен политикой безопасности. Пожалуйста, попробуйте изменить промпт или фото.",
    "sensitive": "🛡 Обнаружен чувствительный контент. Пожалуйста, измените запрос.",

    # 2. Server Capacity & Traffic
    "high demand": "☕ Сервер сейчас перегружен запросами со всего мира. Пожалуйста, подождите минуту и попробуйте снова — у вас обязательно получится!",
    "e003": "☕ Нейросеть временно занята из-за высокой нагрузки. Пожалуйста, попробуйте еще раз через 1-2 минуты.",
    "overload": "☕ Сервер сейчас сильно нагружен. Пожалуйста, подождите немного и попробуйте снова.",
    "traffic": "☕ Сейчас слишком много запросов. Пожалуйста, подождите минутку.",
    "busy": "☕ Система сейчас занята. Попробуйте повторить запрос через мгновение.",
    "unavailable": "🛠 Сервис временно недоступен. Мы уже проводим технические работы, скоро всё заработает!",

    # 3. Image & Content Issues
    "Could not generate images": "🎨 Не удалось создать изображение по вашему описанию. Попробуйте изменить текст или использовать другое фото.",
    "No images found in AI response": "🎨 Нейросеть не смогла выдать результат. Попробуйте немного изменить ваш промпт.",
    "image": "📸 Не удалось обработать ваше фото. Убедитесь, что оно качественное и доступно, или попробуйте другое.",
    "download": "📸 Ошибка при загрузке вашего изображения. Пожалуйста, попробуйте отправить его еще раз.",
    "invalid": "📸 Ваше фото кажется некорректным или поврежденным. Попробуйте использовать другой снимок.",

    # 4. Connection & Timeouts
    "timeout": "⏱ Время ожидания истекло. Сервер не успел ответить вовремя. Пожалуйста, попробуйте нажать кнопку «Повторить» через минуту.",
    "ConnectionError": "🌐 Ошибка соединения. Похоже, возникли временные трудности со связью. Попробуйте еще раз.",

    # 5. Model Issues
    "model_not_supported": "🤖 Эта модель временно отдыхает. Пожалуйста, выберите другую модель в меню настроек.",
    "not supported": "🤖 Данная настройка или модель сейчас недоступна. Попробуйте изменить параметры.",

    # 6. Technical & DB
    "insufficient_funds": "⚡ Недостаточно молний для генерации. Пожалуйста, пополните баланс или выберите модель подешевле.",
    "UndefinedColumnError": "⚙️ Техническая ошибка (БД). Администратор уже уведомлен и чинит это!",
    "ProgrammingError": "⚙️ Внутренняя ошибка запроса. Пожалуйста, попробуйте позже.",
    "Internal Server Error": "⚙️ Что-то пошло не так на сервере. Мы уже работаем над исправлением!",
    "rate limit": "⏳ Вы отправляете запросы слишком быстро. Пожалуйста, сделайте небольшую паузу."
}
